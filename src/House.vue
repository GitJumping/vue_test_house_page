  ...
  <div class="all2-div">
    ...
    <div class="contain-div">
      ...
      <div class="basicdetail-div">
        <div class="basicprice-div">参考价格  住宅<span style="font-size: 30px;font-size: 30px;vertical-align: -2px;color: #f60;margin: 0 5px;"></span> 元/㎡  </div>
        <div class="basicprice-div">楼盘户型  </div>
        <div class="basicprice-div">楼盘地址  </div>
        <div class="blankgreen-div"><a href="#"></a><span></span></div>
